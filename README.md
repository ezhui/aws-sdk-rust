## Note of this fork
This repo is forked from [AWS SDK Rust](https://github.com/awslabs/aws-sdk-rust/tree/main) to resolve the version conflict of zeroize crate.
The original version of zeroize from aws-types is 1.4.1, it conflicts with the version of zeroize from anchor 0.25.0, which is >=1.0 and < 1.4.
So the repo is forked and the zeroize of aws-types is downgraded to 1.3.0, everything is ok.
